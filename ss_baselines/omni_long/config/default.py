...
_TC.TASK.OMNI_LONG_GOAL_SENSOR.USE_PRECOMPUTED_FEATURES = False
_TC.TASK.OMNI_LONG_GOAL_SENSOR.ALLOW_ONLINE_FALLBACK = True
_TC.TASK.OMNI_LONG_GOAL_SENSOR.FEATURES_ROOT = "output"
_TC.TASK.OMNI_LONG_GOAL_SENSOR.FEATURES_FILENAME = "goal_features.pt"
_TC.TASK.OMNI_LONG_GOAL_SENSOR.FEATURE_DIM = 0
_TC.TASK.OMNI_LONG_GOAL_SENSOR.CATEGORY_PROMPT_TEMPLATE = "Find the {category}."
