...
_C.RL = CN()
_C.RL.SUCCESS_REWARD = 20.0
_C.RL.SLACK_REWARD = -0.01
_C.RL.ORDERED_SUCCESS_REWARD = 20.0
_C.RL.UNORDERED_SUCCESS_REWARD = 20.0
_C.RL.ORDERED_SLACK_REWARD = -0.01
_C.RL.UNORDERED_SLACK_REWARD = -0.01
_C.RL.DYNAMIC_TIME_PENALTY = False
...
_C.RL.STOP_PENALTY = -5.0
_C.RL.PREMATURE_STOP_PENALTY = 0.0
_C.RL.FINAL_STOP_REWARD = 0.0
_C.RL.SUBMIT_PENALTY = -2.0
_C.RL.INVALID_SUBMIT_PENALTY = 0.0
_C.RL.FOUND_GOAL_REWARD = 10.0
_C.RL.ORDERED_STOP_PENALTY = -5.0
_C.RL.UNORDERED_STOP_PENALTY = -5.0
_C.RL.ORDERED_PREMATURE_STOP_PENALTY = 0.0
_C.RL.UNORDERED_PREMATURE_STOP_PENALTY = 0.0
_C.RL.ORDERED_FINAL_STOP_REWARD = 0.0
_C.RL.UNORDERED_FINAL_STOP_REWARD = 0.0
_C.RL.ORDERED_SUBMIT_PENALTY = -2.0
_C.RL.UNORDERED_SUBMIT_PENALTY = -2.0
_C.RL.ORDERED_INVALID_SUBMIT_PENALTY = 0.0
_C.RL.UNORDERED_INVALID_SUBMIT_PENALTY = 0.0
_C.RL.ORDERED_FOUND_GOAL_REWARD = 10.0
_C.RL.UNORDERED_FOUND_GOAL_REWARD = 10.0
...
_C.RL.PPO.audio_sensor_uuid = "audiogoal"
_C.RL.PPO.goal_embedding_size = 512
_C.RL.PPO.goal_clip_model = "ViT-B/32"
_C.RL.PPO.goal_image_uuid = "omni_long_goal_image"
_C.RL.PPO.goal_text_uuid = "omni_long_goal_text"
_C.RL.PPO.goal_modality_uuid = "omni_long_goal_modality"
_C.RL.PPO.goal_mask_uuid = "goal_mask"
_C.RL.PPO.task_mode_uuid = "task_mode_flag"
...
_TC.TASK.OMNI_LONG_GOAL_IMAGE_SENSOR = CN()
_TC.TASK.OMNI_LONG_GOAL_IMAGE_SENSOR.TYPE = "OmniLongGoalImageSensor"
_TC.TASK.OMNI_LONG_GOAL_IMAGE_SENSOR.MAX_GOALS = 5
_TC.TASK.OMNI_LONG_GOAL_IMAGE_SENSOR.WIDTH = 224
_TC.TASK.OMNI_LONG_GOAL_IMAGE_SENSOR.HEIGHT = 224

_TC.TASK.OMNI_LONG_GOAL_TEXT_SENSOR = CN()
_TC.TASK.OMNI_LONG_GOAL_TEXT_SENSOR.TYPE = "OmniLongGoalTextSensor"
_TC.TASK.OMNI_LONG_GOAL_TEXT_SENSOR.MAX_GOALS = 5
_TC.TASK.OMNI_LONG_GOAL_TEXT_SENSOR.MAX_TEXT_BYTES = 256
_TC.TASK.OMNI_LONG_GOAL_TEXT_SENSOR.CATEGORY_PROMPT_TEMPLATE = "Find the {category}."

_TC.TASK.OMNI_LONG_GOAL_MODALITY_SENSOR = CN()
_TC.TASK.OMNI_LONG_GOAL_MODALITY_SENSOR.TYPE = "OmniLongGoalModalitySensor"
_TC.TASK.OMNI_LONG_GOAL_MODALITY_SENSOR.MAX_GOALS = 5

_TC.TASK.OMNI_LONG_GOAL_MASK_SENSOR = CN()
_TC.TASK.OMNI_LONG_GOAL_MASK_SENSOR.TYPE = "OmniLongGoalMaskSensor"
_TC.TASK.OMNI_LONG_GOAL_MASK_SENSOR.MAX_GOALS = 5

_TC.TASK.OMNI_LONG_TASK_MODE_SENSOR = CN()
_TC.TASK.OMNI_LONG_TASK_MODE_SENSOR.TYPE = "OmniLongTaskModeSensor"
...
_TC.TASK.OMNI_LONG_DISTANCE_TO_GOAL_REWARD.SUBMIT_SUCCESS_REWARD = 0.0
...
_TC.TASK.OMNI_LONG_DISTANCE_TO_GOAL_REWARD.ORDERED_SUBMIT_SUCCESS_REWARD = 0.0
_TC.TASK.OMNI_LONG_DISTANCE_TO_GOAL_REWARD.UNORDERED_SUBMIT_SUCCESS_REWARD = 0.0
_TC.TASK.OMNI_LONG_DISTANCE_TO_GOAL_REWARD.ORDERED_SUBMIT_SUCCESS_REWARD_INCREMENT = 0.0
...
_TC.TASK.DISTANCE_TO_GOAL.TYPE = "OmniLongDistanceToGoal"
